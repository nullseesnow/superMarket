...
.box{background-image: url('${pageContext.request.contextPath}/res/static/image/bg.jpg');width: 100%;height: 640px;background-size:100%, 100%;}
.video{width:250px;height:250px;margin:auto;background-image: url('${pageContext.request.contextPath}/res/static/image/faceBorder.png')}
	    ...
	    $.ajax({
	        ...
	        data:{
	      	...
	      	success:function(score){
	          	...
	          	if(scoreMatch>80){
	              	//window.location="/WEB-INF/jsp/market/index.jsp"
	              	window.location="${pageContext.request.contextPath}/Page/index"
	             }
	          	else{
